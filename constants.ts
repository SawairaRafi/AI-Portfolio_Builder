...
// IMPORTANT: For client-side usage, the API key will be exposed.
// For production, proxy OpenAI calls through a backend server.
export const OPENAI_API_KEY = process.env.OPENAI_API_KEY; // This should be configured in the environment.
export const OPENAI_MODEL_NAME = "gpt-3.5-turbo"; // Or another model like "gpt-4" if you have access
