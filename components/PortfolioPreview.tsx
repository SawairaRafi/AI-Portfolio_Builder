...
const PortfolioPreview: React.FC<PortfolioPreviewProps> = ({ data, aiContent }) => {
  ...
  return (
    <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg overflow-y-auto bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100 h-[98%]">
