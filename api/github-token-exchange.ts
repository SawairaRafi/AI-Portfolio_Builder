...
// This file (api/github-token-exchange.ts) is a Vercel Serverless Function.
// It acts as a backend proxy to securely exchange a GitHub OAuth code for an access token.
// It must be deployed to Vercel (or a similar serverless platform / Node.js server).
